...
pub use unary::{
    ...
    complex, conj, conj_frule, conj_rrule, cos, cos_frule, cos_rrule, cosh, cosh_frule, cosh_rrule,
    exp, exp10, exp10_frule, exp10_rrule, exp2, exp2_frule, exp2_rrule, exp_frule, exp_rrule,
    expm1, expm1_frule, expm1_rrule, hypot, hypot_frule, hypot_rrule, imag, imag_rrule, inv,
    inv_frule, inv_rrule, log, log10, log10_frule, log10_rrule, log1p, log1p_frule, log1p_rrule,
    log2, log2_frule, log2_rrule, log_frule, log_rrule, pow, pow_frule, pow_rrule, real,
    real_rrule, sin, sin_frule, sin_rrule, sincos, sincos_frule, sincos_rrule, sinh, sinh_frule,
    sinh_rrule, sqrt, sqrt_frule, sqrt_rrule, tan, tan_frule, tan_rrule, tanh, tanh_frule,
    tanh_rrule,
};
